...
let totalGames = GAMES_JSON.length.toLocaleString('en-US')
...
const displayString = 
    `A total of $${amountRaised} has been raised for ${totalGames} games.
    Currently, ${unfundedGames == 1 ? "1 game remains" : `${unfundedGames} games remain`} unfunded. 
    We need your help to fund these amazing games!`

// create a new DOM element containing the template string and append it to the description container
let templateStringDiv = document.createElement("p")
templateStringDiv.innerHTML = displayString
descriptionContainer.append(templateStringDiv)
...
let [topPledge, runnerUp, ...others] = sortedGames

// create a new element to hold the name of the top pledge game, then append it to the correct element
firstGameContainer.innerHTML += topPledge.name

// do the same for the runner up item
secondGameContainer.innerHTML += runnerUp.name